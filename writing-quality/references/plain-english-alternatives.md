...
Use this table when a shorter or more familiar word is equally accurate. These are options, not mechanical replacements. Preserve established terminology, domain precision, legal meaning, quoted text, and the user's spelling convention.
...
## Phrases to remove when they add no meaning
...
- I am of the opinion that; prefer "I think"
- in due course; prefer "soon" or give a date
